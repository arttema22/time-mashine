<div class="relative w-full max-w-3xl mx-auto" x-data="{ open: @entangle('showResults'), focused: false }"
    ...
    <div class="flex gap-2 mt-2">
        ...
        <button wire:click="selectFilter('{{ $value }}')"
            class="px-3 py-1 text-sm rounded-full {{ $selectedFilter === $value ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
            {{ $label }}
        </button>
        @endforeach
    </div>
