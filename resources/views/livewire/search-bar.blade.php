<div class="relative w-full max-w-3xl mx-auto" x-data="{ open: @entangle('showResults'), focused: false }" @keydown.escape.window="open = false"
    ...
    <div class="flex gap-2 mt-2 flex-wrap">
        {{-- @foreach (['all' => 'Все', 'people' => 'Люди', 'organizations' => 'Организации', 'events' => 'События'] as $value => $label) --}}
        @foreach (['all' => 'Все', 'people' => 'Люди', 'organizations' => 'Организации'] as $value => $label)
                ...
                <a href="{{ $result['url'] }}"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span
                            ...
                            {{ $result['type'] === 'people' ? 'bg-primary-500 text-white' : '' }}
