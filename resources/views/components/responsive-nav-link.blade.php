...
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary-500 dark:border-indigo-600 text-start text-base font-medium
text-primary-500 dark:text-indigo-300 bg-primary-50 dark:bg-indigo-900/50 focus:outline-none focus:text-indigo-800
