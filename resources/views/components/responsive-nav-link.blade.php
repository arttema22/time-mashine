...
@php
    $classes =
        $active ?? false
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary-500 text-start text-base font-medium
text-primary-500 dark:text-indigo-300 bg-primary-50 dark:bg-indigo-900/50 focus:outline-none focus:text-primary-500
dark:focus:text-indigo-200 focus:bg-indigo-100 dark:focus:bg-indigo-900 focus:border-primary-500
dark:focus:border-primary-500 transition duration-150 ease-in-out'
